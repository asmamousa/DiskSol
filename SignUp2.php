...
<p class="message"> This account already existed </p>
...
<div class="container container2" style="height: 500px ; width : 950px;background-color: white ">
    ...
    <div class="form">
        <div class="thumbnail">
            ...
            <form name="form" class="login-form" method="post"  action="SignUpSessions2.php" id="log" >
                &emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;

                <div class="buttoninput"> <input type="text" placeholder="ID (4 digits)" name="ID3" id="ID3" pattern="[0-9]{4}"/></div>
                &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                <div class="buttoninput"> <input type="password" placeholder="password" name="pass2" id="pass2" /></div>

                &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                <div class="buttoninput"> <input type="text" placeholder="your name" name="N1" id="N1" /></div>



                <br> <br><br><br>
                &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                <button class="buttoninput" style="color: black ; opacity: .9; ">Sign Up</button>
